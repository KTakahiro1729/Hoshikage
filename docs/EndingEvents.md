...
帰結: キャロルに危険が迫ったとき、GMからキャロルへ「あなたの信仰する神を讃えて下さい」と促す。この時、キャロルが「ハスター様万歳！」などハスターを讃えるRPをした場合、ハスター様のご加護によって「幸運にも」この危険をはねのけることができる。パッシブ発動で一度だけ。（ダイス勝負中であれば、+10pt分付与される）
