...
全員に[共通ハンドアウト、印刷用白地図、オープニング台本、各 PC 用ハンドアウト](Resources.md)の配布をお願いします。共通ハンドアウトと印刷用白地図は**ネタバレを含み<u>ません</u>**ので、プレイヤー集めの段階から見せていただいて問題ありません。各 PC 用ハンドアウトは遅くとも、プレイ開始の 2, 3 日前に渡しておいてください。
...
| Q5. |                   歌を歌った時間は？（2 回）                    |                           00:04 と 02:50 頃                           |
...
Q5. 歌を歌った時間は？（2回） →　00:04と02:50頃</br>
